...
import pandas as pd
import numpy as np
from PathDSP_exp_target.validation import prep_data, train_val, hyper_tune_main
...
if __name__ == '__main__':
    ...
    # ------------------------- running model from scratch (not loading pretrained ---------------------------
        ...
        if args.tuning==True:
            ...
            trainset, valset = prep_data(cl_exp, cl_mut, cl_cnv, drug_fp, drug_target,
                                         label_matrix, indices, fold_type=foldtype, 
                                         train_fold=[0,1,2], val_fold=[3]) 
            
            epoch, epoch_avg5, best_trial_config = hyper_tune_main(trainset, valset,
                                                                   fold_type=foldtype, grid=config, 
